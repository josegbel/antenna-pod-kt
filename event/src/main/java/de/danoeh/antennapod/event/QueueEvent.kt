...
class QueueEvent private constructor(
    @JvmField val action: Action,
    @JvmField val item: FeedItem?,
    @JvmField val items: MutableList<FeedItem>?,
    ...
    companion object {
        ...
        @JvmStatic
        fun setQueue(queue: MutableList<FeedItem>?): QueueEvent {
        ...
        @JvmStatic
        fun sorted(sortedQueue: MutableList<FeedItem>?): QueueEvent {
